...
switch($method) {
    ...
    case "POST":
        ...
        $sql = "INSERT INTO contracts(id, contractName, officerName, employeeNumber, startdate,enddate,totalCost,companyName , companyLocation, companyEmployeeName,companyNumber,description) VALUES(null, :contractName, :officerName, :employeeNumber, :startdate, :enddate, :totalCost,:companyName, :companyLocation ,:companyEmployeeName ,:companyNumber,:description)";
        $stmt = $conn->prepare($sql);
